...
TEXT,
  ...
  [
    'title' => 'Как использовать пустое пространство в интерфейсе',
    'slug' => 'kak-ispolzovat-pustoe-prostranstvo-v-interfeyse',
    'image' => 'https://images.unsplash.com/photo-1559028012-481c04fa702d?auto=format&fit=crop&w=1200&q=80',
    'description' => 'Свободное пространство помогает выделить главное и сделать интерфейс спокойнее.',
    'content' => <<<'TEXT'
Пустое пространство не означает, что в интерфейсе чего-то не хватает. Оно помогает разделить связанные блоки, выделить заголовок и упростить чтение длинного текста.

Отступы стоит задавать системно: одинаковые расстояния между однотипными элементами делают страницу понятнее и уменьшают визуальный шум.
TEXT,
    'views' => 351,
